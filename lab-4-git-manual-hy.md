...
- համագործակցել GitHub-ի կամ այլ git միջավայրի միջոցով
...
- տեղադրված է code editor (notepad, notepad++, sublime, VS code …)
- գիտեք terminal-ի հիմնական հրամանները
- ունեք GitHub կամ այլ git միջավայրի account
...
# 7. Git-ի հիմնական աշխատանք (բերված է terminal֊ի հրամնների օրինակ)

## Ստեղծել project (թղթապանակ և տեղափոխվել այնտեղ)
...
## Clone անել repository (teminal)

```bash
git clone https://github.com/username/repository.git
```

Մուտք գործել թղթապանակ`
